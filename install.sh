...
# download github - Updated to use Python 3.13 compatible version
echo "Downloading francinette (Python 3.13 compatible) from Prashant-Bharaj/francinette..."
...
if ! python3 -m venv venv ; then
	...
	echo 'Contact me if you have no idea how to proceed'
	exit 1
fi
...
if ! pip3 install -r requirements.txt ; then
	echo 'Problem launching the installer. Please check your Python version (Python 3.12+ recommended)'
	exit 1
fi
...
printf "\033[32mThis version includes Python 3.13 compatibility fixes!\033[0m\n"
